...
| 02 | Realizar o login no aplicativo e conseguir acessar a próxima página "Home" do app. | Identificar se existem dificuldades no login via app e ao direcionamento na página "Home".| Terminar o login e acessar a página "Home" do app sem expressar dificuldades durante esse processo.|
| 03 | Acessar a página de Registros dos Clientes no aplicativo. | Identificar se existem dificuldades no acesso na página de Registro dos Clientes.| Acessar a página "Registros dos Clientes" do app sem expressar dificuldades durante esse processo.|
| 04 | Acessar a página de Cadastro de Clientes e adicionar clientes no aplicativo. | Identificar se existem dificuldades no acesso na página de "Registro de Clientes" e na sequência, avaliar se o layout e o fluxo são intuitivos para confirmar essa operação de adicionar clientes na plataforma.| Acessar a página "Registros dos Clientes" do app e adicionar clientes sem expressar dificuldades durante esse processo.|
| 05 | Acessar a página de Registro dos Treinos no aplicativo. | Identificar se existem dificuldades no acesso na página de "Registro de Treinos" e na sequência, avaliar se o layout e o fluxo são intuitivos para confirmar essa operação.| Acessar a página "Registros dos Treinos" do app e adicionar clientes sem expressar dificuldades durante esse processo.|
| 06 | Cadastrar Treinos.| Identificar se existem dificuldades no acesso na página de "Cadastrar Treinos" e em preencher todos os dados disponibilizados na plataforma: "Nome", "Data", "Início", "Duração" e "Valor do Treino". Na sequência, avaliar se o layout e o fluxo são intuitivos para confirmar esse procedimento.| Acessar a página, cadastrar e adicionar Treinos do app sem expressar dificuldades durante esse processo.|
| 07 | Tela de Registro e Valores de Treinos.| Identificar se existem dificuldades no acesso na página "Home" para verificar se os dados dos registros dos treinos e os valores foram cadastrados corretamente e se estão sendo exibidos de maneira simples no layout da plataforma. Na sequência, avaliar se o layout e o fluxo são intuitivos para confirmar essa operação.| Acessar a página "Home" do app sem expressar dificuldades durante esse processo e visualizar de maneira simples os dados visíveis no app.|
| 08 | Tela de Quitar Dívidas.| Identificar se existem dificuldades no acesso na página "Quitar Dívidas". Na sequência, avaliar se o layout e o fluxo são intuitivos para confirmar essa operação.| Acessar a página "Quitar Dívidas" do app sem expressar dificuldades durante esse processo.|
| 09 | Quitar Dívidas.| Identificar se existem dificuldades no acesso na página "Quitar Dívidas", preencher o  checkbox disponibilizado n aplataforma e quitar uma dívida cadastrada na aplicação. Na sequência, avaliar se o layout e o fluxo são intuitivos para confirmar esse procedimento.| Acessar a página "Quitar Dívidas", preencher o checkbox disponibilizado e quitar uma dívida cadastrada no app sem expressar dificuldades durante esse processo.|
| 10 | Editar Treino.| Identificar se existem dificuldades no acesso na página "Editar Treino" e preencher os os campos descritos na plataforma: "Nome", "Data", "Início", "Duração" e "Treino". Na sequência, avaliar se o layout e o fluxo são intuitivos para confirmar esse procedimento.| Acessar a página "Editar Treino", preencher os campos disponibilizados e confirmar a edição dos dados sem expressar dificuldades durante essa ação.|
